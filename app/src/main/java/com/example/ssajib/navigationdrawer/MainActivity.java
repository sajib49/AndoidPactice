package com.example.ssajib.navigationdrawer;
...
import com.example.ssajib.navigationdrawer.fragment.DepartmentFragment;
import com.example.ssajib.navigationdrawer.fragment.EmployeeFragment;
...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lv_Department = (ListView) findViewById(R.id.lvDepartment);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_camera) {
            ...
            EmployeeFragment hello = new EmployeeFragment();
            ...
            FragmentManager fragmentManager = getFragmentManager();
            FragmentTransaction fragmentTransaction = fragmentManager.beginTransaction();
            DepartmentFragment hello = new DepartmentFragment();
            fragmentTransaction.add(R.id.fragmentContainer, hello, "HELLO");
            fragmentTransaction.commit();
            //Toast.makeText(getApplicationContext(),"gallery Click...",Toast.LENGTH_LONG).show();
        } else if (id == R.id.nav_slideshow) {

            Toast.makeText(getApplicationContext(),"slide show Click...",Toast.LENGTH_LONG).show();
        } else if (id == R.id.nav_manage) {
            Toast.makeText(getApplicationContext(),"manage Click...",Toast.LENGTH_LONG).show();
        }
       /* else if (id == R.id.nav_share) {
            Toast.makeText(getApplicationContext(),"share Click...",Toast.LENGTH_LONG).show();
        } else if (id == R.id.nav_send) {
            Toast.makeText(getApplicationContext(),"send Click...",Toast.LENGTH_LONG).show();
        }*/
